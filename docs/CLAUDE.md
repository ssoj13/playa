...
This project is indexed by GitNexus as **playa** (6021 symbols, 10208 relationships, 157 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
