...
## HIGH Priority
  ...
  1. контролы слева в таймлайне не выровнены из-за разных длин имён. Нужно выровнять.
  2. в Attribute editor при нажатом shift значение должно меняться на 5%, при ctrl - на 1%.
  3. видимо кастомные сеттеры in/out/trim_in/trim_out надо интегрировать прямо в Attrs.set, это спецкейс. Как лучше сделать? Или какой-то единый сеттер для всех параметров? Нужно чтобы trim_in/out умно следовал на in/out.
