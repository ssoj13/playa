...
pub fn render(
    ...
    ui.horizontal(|ui| {
        ...
        if ui.button("ΓÅ«").on_hover_text("To Start").clicked() {
        ...
        let play_icon = "Γû╢"; // Will be updated based on playback state
        ...
        if ui.button("ΓÅ╣").on_hover_text("Stop").clicked() {
        ...
        if ui.button("ΓÅ¡").on_hover_text("To End").clicked() {
