...
echo "========================================="
echo ""
echo "Next CI build will sign the app with your Developer ID certificate."
echo ""
echo "========================================="
echo "⚠️  Next Step: Configure Notarization"
echo "========================================="
echo ""
echo "Code signing alone is NOT enough!"
echo "Without notarization, users will see: 'Apple could not verify'"
echo ""
echo "To enable notarization, see: NOTARIZATION.md"
echo ""
echo "Quick summary:"
echo "  Method 1 (Recommended): App Store Connect API"
echo "    - Create API key at: https://appstoreconnect.apple.com"
echo "    - Add secrets: APPLE_API_KEY, APPLE_API_ISSUER, APPLE_API_KEY_PATH"
echo ""
echo "  Method 2 (Simpler): Apple ID credentials"
echo "    - Generate app-specific password at: https://appleid.apple.com"
echo "    - Add secrets: APPLE_ID, APPLE_PASSWORD, APPLE_TEAM_ID"
echo ""
echo "For detailed instructions: cat NOTARIZATION.md"
echo ""
