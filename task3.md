...
## HIGH Priority
  ...
  3. Добавь Ctrl-D в локальные кнопки Timeline: оно должно создавать копию текущего layer в этой parent Comp. Имя должно быть новое.
  4. Добавь в Timeline clipboard: чтобы можно было Ctrl-C выделенные слои, и Ctrl-V их где надо. продумай это.
  5. При клике на пустом месте под слоями селекшн должен сбрасываться.
  6. Можно в Preferences чекбокс Tooltips и если он включёт - показывать на всех элементах тултипы? Проанализируй.
  7. Сделай толщину линии обводки слоя 1 px
  8. Сделай режим trim slide: 
