...
use super::keys::{A_IN, A_OUT, A_SPEED, A_SRC_LEN, A_TRIM_IN, A_TRIM_OUT};
...
mod tests {
    ...
    fn test_projection_matrix_orthographic() {
        ...
        cam.attrs.set(
            "projection_type",
            super::AttrValue::Str("orthographic".to_string()),
        );
